...
(docker compose config | Select-String "(scr\.sitecore\.com\/.+)|(mcr\.microsoft\.com\/.+)|(traefik\:v.+)").Matches | Select-Object -Unique | ForEach-Object { $_.Value } | ForEach-Object { docker image pull $_ }
